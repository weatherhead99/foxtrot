...
std::size_t foxtrot::tuple_size(const rttr::variant& var)
{
...
rttr::type foxtrot::tuple_type(const rttr::variant& var, int n)
{
    auto tp = var.get_type();
    ...
    auto elem_type_ret = typemeth.invoke(rttr::instance(var), {n});
